...
"""
joins in pandas
combine multiple dataframes based on a column
"""
...
print(f"each movie review count {data["title"].value_counts()}")

print(f"each movie average  rating {data.groupby("title")["rating"].mean()}")

print(f"year wise movie count {movies["year"].value_counts()}")

print(f"language wise movie count {movies["language"].value_counts()}")

print(f"language wise average rating {data.groupby("language")["rating"].mean()}")

print(f"language wise review count {data["language"].value_counts()}")