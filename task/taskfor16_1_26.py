...
print(df[df["brand"]=="Nike"])

#Find all 'Men' category items that are 'Blue'.
print(df[(df["category"]=="Men") & (df["color"]=="Blue")] )

#Category Count: How many products exist for each category ('Men', 'Women', 'Kids')

print(df['category'].value_counts())

#What is the average price of a 'Zara' product

print(df[(df['brand']=="Zara")]["price"].mean())
